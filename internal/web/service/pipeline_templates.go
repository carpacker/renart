...
FROM (VALUES
    (1, 'Ada', 'team', 'GB', 34),
    (2, 'Grace', 'enterprise', 'US', 33),
    (3, 'Alan', 'free', 'GB', 32),
    (4, 'Katherine', 'team', 'US', 31),
    (5, 'Margaret', 'enterprise', 'US', 30),
    (6, 'Claude', 'free', 'US', 29),
    (7, 'Edsger', 'team', 'NL', 28),
    (8, 'Barbara', 'enterprise', 'US', 27),
    (9, 'Donald', 'free', 'US', 26),
    (10, 'Radia', 'team', 'US', 25),
    (11, 'Annie', 'enterprise', 'US', 24),
    (12, 'John', 'free', 'HU', 23),
    (13, 'Mary', 'team', 'US', 22),
    (14, 'Linus', 'enterprise', 'FI', 21),
    (15, 'Frances', 'free', 'US', 20),
    (16, 'Ken', 'team', 'US', 19),
    (17, 'Guido', 'enterprise', 'NL', 18),
    (18, 'Jean', 'free', 'US', 17),
    (19, 'Tim', 'team', 'GB', 16),
    (20, 'Sophie', 'enterprise', 'CA', 15),
    (21, 'James', 'free', 'US', 14),
    (22, 'Karen', 'team', 'DK', 13),
    (23, 'Martin', 'enterprise', 'GB', 12),
    (24, 'Katie', 'free', 'US', 11)
