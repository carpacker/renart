...
| [pipeline-readiness-and-rendering.md](pipeline-readiness-and-rendering.md) | implementation in progress — Phases 1–3 and the functional universal run ledger, including exact retained-plan re-execution, have shipped; rolling legacy-job cleanup and optional Phase 4 policy/automation remain |
