...
| [pipeline-readiness-and-rendering.md](pipeline-readiness-and-rendering.md) | implementation in progress — Phases 1–3 plus durable scheduled dispatch and inline full-pipeline ledger shipped; asset/scoped and Build-needed ledger coverage, exact re-execution, and optional Phase 4 policy remain |
