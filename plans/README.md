...
| [pipeline-readiness-and-rendering.md](pipeline-readiness-and-rendering.md) | implementation in progress — Phases 1–3 shipped (rendering, reviewed execution/history, reviewed deploy/promotion, scheduled variables and retained actual-tick plans); universal direct-path ledger coverage, durable occurrences/attempts, exact re-execution, and optional Phase 4 policy remain |
