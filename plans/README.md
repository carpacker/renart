...
| [pipeline-readiness-and-rendering.md](pipeline-readiness-and-rendering.md) | implementation in progress — Phases 1–3 plus durable scheduled occurrences/attempts and run-ID-only scheduled dispatch shipped; universal direct-path ledger coverage, exact re-execution, and optional Phase 4 policy remain |
