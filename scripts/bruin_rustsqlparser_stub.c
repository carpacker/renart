...
char *bruin_rustsqlparser_get_tables(const char *query, const char *dialect) {
    (void)query;
    (void)dialect;
    return copy_response("{\"tables\":[],\"error\":\"Bruin RustSQLParser is disabled; Renart uses embedded Polyglot WASM\"}");
}
...
char *bruin_rustsqlparser_rename_tables(const char *query, const char *dialect, const char *table_mapping_json) {
    ...
    return copy_response("{\"query\":\"\",\"error\":\"Bruin RustSQLParser is disabled; Renart uses embedded Polyglot WASM\"}");
}
...
char *bruin_rustsqlparser_is_single_select(const char *query, const char *dialect) {
    (void)query;
    (void)dialect;
    return copy_response("{\"is_single_select\":false,\"error\":\"Bruin RustSQLParser is disabled; Renart uses embedded Polyglot WASM\"}");
}
...
char *bruin_rustsqlparser_column_lineage(const char *query, const char *dialect, const char *schema_json) {
    ...
    return copy_response("{\"columns\":\"Bruin RustSQLParser is disabled; Renart uses embedded Polyglot WASM\"}");
}
...
char *bruin_rustsqlparser_hoist_declares_list(const char *queries_json, const char *dialect) {
    (void)queries_json;
    (void)dialect;
    return copy_response("{\"queries\":[],\"error\":\"Bruin RustSQLParser is disabled; Renart uses embedded Polyglot WASM\"}");
}
