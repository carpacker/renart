...
[`architecture/renart-docs-framework.md`](../architecture/renart-docs-framework.md);
the companion [`architecture/renart-user-docs-concept.md`](../architecture/renart-user-docs-concept.md)
